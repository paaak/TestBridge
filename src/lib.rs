...
#[derive(Debug)]
pub struct TestBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TestBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TestBridge processing");
    
    let mut processor = TestBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TestBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TestBridgeProcessor::new(false);
